import { $t } from '../i18n';
export function getAlertsConfig(host, platforms = []) {
    return {
        donation: {
            type: 'donation',
            name: $t('Donation'),
        ...
        fanfunding: {
            ...
            tooltipLink: 'https://creatoracademy.youtube.com/page/lesson/superchat-and-superstickers_what-is-superchat_video',
        },
        facebook_support: {
