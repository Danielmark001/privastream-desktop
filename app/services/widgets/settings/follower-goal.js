...
let FollowerGoalService = class FollowerGoalService extends GenericGoalService {
    getApiSettings() {
        return {
...
FollowerGoalService.initialState = WIDGET_INITIAL_STATE;
FollowerGoalService = __decorate([
    InheritMutations()
], FollowerGoalService);
export { FollowerGoalService };
//# sourceMappingURL=follower-goal.js.map