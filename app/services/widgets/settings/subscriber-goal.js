...
let SubscriberGoalService = class SubscriberGoalService extends GenericGoalService {
    getApiSettings() {
        return {
...
SubscriberGoalService.initialState = WIDGET_INITIAL_STATE;
SubscriberGoalService = __decorate([
    InheritMutations()
], SubscriberGoalService);
export { SubscriberGoalService };
//# sourceMappingURL=subscriber-goal.js.map