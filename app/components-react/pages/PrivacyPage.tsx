        ...
        <Card title={<span style={textStyle}>General Settings</span>} style={cardStyle} bordered={false}>
          <div style={{ marginBottom: 16 }}>
            ...
            <Switch 
              ...
              onChange={(v) => updateSetting('blur_enabled', v)} 
            />
          </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Slider 
              ...
              onChange={(v) => updateSetting('blur_strength', v)} 
            />
          </div>
          ...
          <div>
            ...
            <Slider 
              ...
              onChange={(v) => updateSetting('face_detection_confidence', v)} 
            />
          </div>
        </Card>
      </div>
        ...
        <Card title={<span style={textStyle}>Whitelisted Faces (Safe to Show)</span>} style={cardStyle} bordered={false}>
          <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
            <Input 
              ...
              style={{ backgroundColor: '#17242D', color: 'white', border: '1px solid #3a4b57' }}
            />
          ...
          <List
            ...
            renderItem={item => (
              <List.Item style={{ borderBottom: '1px solid #2b3b47' }}>
