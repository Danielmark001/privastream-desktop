    ...
    return (<div className={styles.container}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.optionContainer}>
          {optionsMetadata.map(data => (<Tooltip title={data.description} placement="bottom" key={data.title}>
              <div className={commonStyles.optionCard} onClick={() => data.onClick()} style={{ background: `var(${data.color})` }}>
                {data.image}
                <h2 style={{
...
const SvgBackground = () => (<svg width="100%" height="100%" viewBox="0 0 1083 720" xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=FreshOrImport.jsx.map