      ...
      <div className={styles.titleContainer}>
        ...
        <div>
          ...
          <div className={styles.optionContainer}>
            <div className={cx(styles.option, { [styles.active]: active === 'streaming' })} onClick={() => setActive('streaming')}>
              <i className="icon-broadcast"></i>
              <h2>{$t('Live Streaming')}</h2>
            </div>
            <div className={cx(styles.option, { [styles.active]: active === 'recording' })} onClick={() => setActive('recording')}>
        ...
        <div className={cx(styles.buttonContainer, { [styles.active]: shouldShowContinue })}>
          <Button type="primary" shape="round" style={{ width: 200, height: 60, fontSize: 16 }} disabled={!active} onClick={onContinue}>
            {$t('Continue')}
          </Button>
        </div>
      </div>
...
const SvgBackground = () => (<svg width="100%" height="100%" viewBox="0 0 900 720" xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=StreamingOrRecording.jsx.map