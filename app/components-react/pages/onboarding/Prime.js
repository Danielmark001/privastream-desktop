...
export function Prime() {
    ...
    useWatchVuex(() => UserService.views.isPrime, isPrime => isPrime && next());
    return (React.createElement("div", { className: styles.container },
        React.createElement("div", { style: { width: '100%' } },
            React.createElement("h1", { className: commonStyles.titleContainer, style: { marginTop: '20px' } }, $t('Choose your plan')),
            React.createElement("div", { className: commonStyles.subtitleContainer }, $t('Choose the best plan to fit your content creation needs.')),
            React.createElement(UltraComparison, Object.assign({ onSkip: next, refl: "slobs-onboarding" }, tableProps)))));
}
