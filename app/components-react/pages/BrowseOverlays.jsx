...
export default function BrowseOverlays(p) {
    ...
    if (!overlaysUrl)
        return <></>;
    return (<BrowserView className={p.className} onReady={onBrowserViewReady} src={overlaysUrl} style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0 }} enableGuestApi setLocale/>);
}
//# sourceMappingURL=BrowseOverlays.jsx.map