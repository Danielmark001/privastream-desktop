...
export default function PatchNotes(p) {
    ...
    return (<div className={cx(styles.patchNotesPage, p.className)}>
      <div className={styles.patchNotesContainer}>
        <div className={styles.patchNotesContent}>
          ...
          <ul className={styles.patchNotesList}>
            {notes.notes.map(item => (<li className={styles.patchNotesItem} key={item}>
                {item}
              </li>))}
          </ul>
...
//# sourceMappingURL=PatchNotes.jsx.map