...
export default function Highlighter(props) {
    ...
    const updaterModal = React.createElement(UpdateModal, null);
    switch (viewState.view) {
        case EHighlighterView.STREAM:
            return (React.createElement(React.Fragment, null,
                aiHighlighterFeatureEnabled && updaterModal,
                React.createElement(StreamView, { emitSetView: data => {
                        setViewFromEmit(data);
                    } })));
        case EHighlighterView.CLIPS:
            return (React.createElement(React.Fragment, null,
                aiHighlighterFeatureEnabled && updaterModal,
                React.createElement(ClipsView, { emitSetView: data => {
                        setViewFromEmit(data);
                    }, props: {
                        id: viewState.id,
        ...
        default:
            return (React.createElement(React.Fragment, null,
                aiHighlighterFeatureEnabled && updaterModal,
                React.createElement(SettingsView, { close: () => {
