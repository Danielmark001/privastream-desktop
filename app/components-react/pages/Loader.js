...
export default function Loader(p) {
    ...
    return (React.createElement("div", { className: cx('s-loader', p.className) },
        React.createElement("div", { className: "s-loader__bg" },
            React.createElement("div", { className: "s-loader__inner" },
                React.createElement(Spinner, null),
                React.createElement("div", { className: "s-loader__text" }, loaderText)))));
}
export function Spinner() {
    return (React.createElement("div", { className: "s-spinner s-spinner__overlay" },
        React.createElement("div", { className: "s-bars" },
            React.createElement(SvgContainer, { src: spinnerSrc, className: "s-spinner--large" }))));
}
const spinnerSrc = `
<svg
version="1.1"
