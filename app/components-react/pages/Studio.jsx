...
export default function Studio(p) {
    ...
    return (<Layout className={p.className} data-name="editor-page" childrenMins={childrenMins} onTotalWidth={(slots, isColumns) => totalWidthHandler(slots, isColumns)}>
      {children}
    </Layout>);
}
//# sourceMappingURL=Studio.jsx.map