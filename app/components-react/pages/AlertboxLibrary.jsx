...
export default function AlertboxLibrary(p) {
    ...
    if (!libraryUrl)
        return <></>;
    return (<BrowserView className={p.className} style={{ position: 'absolute', top: '0', left: '0', right: '0', bottom: '0' }} src={libraryUrl} enableGuestApi setLocale onReady={onBrowserViewReady}/>);
}
//# sourceMappingURL=AlertboxLibrary.jsx.map