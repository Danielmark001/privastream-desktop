...
export default function PlatformAppMainPage(p) {
    ...
    return (React.createElement("div", { className: p.className, style: { height: '100%', width: '100%', margin: poppedOut && '20px' } }, poppedOut ? ($t('This app is currently popped out in another window.')) : (React.createElement(PlatformAppPageView, { appId: p.params.appId, pageSlot: pageSlot, key: p.params.appId, style: { height: '100%' } }))));
}
//# sourceMappingURL=PlatformAppMainPage.js.map