...
export function OnePane(p) {
    ...
    return (<div className={cx(styles.columns, styles.sidePadded, p.className)} ref={componentRef}>
      <ResizeBar position="left" value={bars.bar1} onInput={(value) => setBar('bar1', value)} max={calculateMax(mins.rest)} min={mins.bar1}>
      ...
      <div className={styles.rows} style={{ width: `${resizes.bar1 * 100}%`, paddingTop: '16px' }}>
        ...
        <div className={styles.segmented}>
          ...
          <div className={styles.cell}>{((_e = p.children) === null || _e === void 0 ? void 0 : _e['5']) || <></>}</div>
        </div>
      </div>
    </div>);
}
//# sourceMappingURL=OnePane.jsx.map