...
export function DualOutputSourceSelector(p) {
    ...
    return (<>
      {showHorizontalToggle && (<Tooltip title={horizontalToggleMessage} placement="left" visible={['icon-desktop', 'icon-desktop-hide'].includes(hoveredIcon)}>
          <i onClick={() => {
      ...
      {showVerticalToggle && (<Tooltip title={verticalToggleMessage} placement="left" visible={['icon-phone-case', 'icon-phone-case-hide'].includes(hoveredIcon)}>
          <i onClick={() => {
...
//# sourceMappingURL=DualOutputSourceSelector.jsx.map