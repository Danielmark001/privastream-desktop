...
export default function GLVolmetersWithContext() {
    ...
    return (React.createElement(GLVolmetersCtx.Provider, { value: controller },
        React.createElement(GLVolmeters, null)));
}
function GLVolmeters() {
    ...
    return (React.createElement("div", { style: { position: 'absolute', height: '100%', width: '100%' } },
...
//# sourceMappingURL=GLVolmeters.js.map