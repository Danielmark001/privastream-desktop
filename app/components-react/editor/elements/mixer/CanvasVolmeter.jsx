...
export default function MixerVolmeter(p) {
    ...
    return (<div className="volmeter-container">
      {renderingInitialized && (<canvas style={{ position: 'absolute', overflow: 'hidden', backgroundColor: 'var(--border)' }} ref={canvas}/>)}
      <div style={{ margin: '10px 0' }} ref={spacer}/>
    </div>);
}
//# sourceMappingURL=CanvasVolmeter.jsx.map