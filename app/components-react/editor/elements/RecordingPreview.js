...
export function RecordingPreview() {
    ...
    const { renderElement } = useBaseElement(React.createElement(RecPreview, null), mins, containerRef.current);
