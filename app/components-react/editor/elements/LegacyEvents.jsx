...
export function LegacyEvents(p) {
    ...
    function Element() {
        ...
        <BrowserView className={styles.eventContainer} src={UserService.recentEventsUrl()} setLocale={true} onReady={(view) => handleBrowserViewReady(view)} hidden={hideStyleBlockers}/>
      </div>);
    }
...
//# sourceMappingURL=LegacyEvents.jsx.map