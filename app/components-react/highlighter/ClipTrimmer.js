...
export default function ClipTrimmer(props) {
    ...
    const [scrubFrames, setScrubFrames] = useState([]);
    ...
    function updatePlayhead() {
        ...
        if (!playPastEnd.current && videoRef.current.currentTime >= endTime)
            stopPlaying();
    ...
    function onMouseMove(e) {
        ...
        if (isDragging.current) {
            if (isDragging.current === 'start') {
                const timelineOffset = timelineRef.current.getBoundingClientRect().left + 20;
                const time = ((e.clientX + dragOffset.current - timelineOffset) / timelineWidth) *
                    props.clip.duration;
                ...
                const time = ((timelineOffset + dragOffset.current - e.clientX) / timelineWidth) *
                    props.clip.duration;
    ...
    function stopDragging() {
        ...
        playAt(localStartTrim);
        UsageStatisticsService.actions.recordAnalyticsEvent(HighlighterService.state.useAiHighlighter ? 'AIHighlighter' : 'Highlighter', { type: 'Trim', clipPath: props.clip.path, streamId: props.streamId });
    }
    ...
    useEffect(() => {
        ...
        setScrubFrames(times(nFrames).map(n => {
    ...
    return (React.createElement("div", null,
        React.createElement("video", { ref: videoRef, src: props.clip.path.replace('#', '%23'), style: { borderRadius: 5 }, width: "100%", onEnded: () => {
                setIsPlaying(false);
            }, onClick: togglePlayPause }),
        React.createElement("h3", { style: { margin: '6px 0 10px' } }, $t('Trim Clip')),
        React.createElement("div", { ref: timelineRef, style: {
                width: '100%',
                height: scrubHeight,
                position: 'relative',
            ...
            React.createElement("div", { style: { display: 'flex', overflow: 'hidden', position: 'absolute' } }, scrubFrames.map(frame => {
                var _a;
                return (React.createElement("img", { key: frame, src: (_a = props.clip.scrubSprite) === null || _a === void 0 ? void 0 : _a.replace('#', '%23'), width: SCRUB_WIDTH, height: SCRUB_HEIGHT, style: {
                        height: scrubHeight,
                        width: scrubWidth,
                        objectFit: 'cover',
            ...
            React.createElement("div", { style: { position: 'absolute', width: '100%', height: '100%' } },
                ...
                React.createElement("div", { style: {
                        ...
                        alignItems: 'center',
                    }, onMouseDown: e => startDragging(e, 'start'), ref: startDragRef },
                ...
                React.createElement("div", { style: {
                        ...
                        justifyContent: 'center',
                        alignItems: 'center',
                    }, onMouseDown: e => startDragging(e, 'end'), ref: endDragRef },
...
//# sourceMappingURL=ClipTrimmer.js.map