...
export function ImportStreamModal({ close, openedFrom, videoPath, selectedGame, streamInfo, }) {
    ...
    return (<>
      <div className={cx(styles.hypeWrapper, (gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) && styles.hypeWrapperWithImportConfig)} style={{
        ...
        <div className={styles.hypeContent}>
          <img className={`${styles.artworkImage} ${isAnimating ? styles.fadeOut : styles.fadeIn}`} src={artwork} alt=""/>
          ...
          <div className={styles.contentDivider}>
            ...
            ((_f = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _f === void 0 ? void 0 : _f.verticalExampleVideo) && (<div style={{ position: 'relative' }}>
        ...
        <div className={styles.manualUploadWrapper} style={{
          ...
          <TextInput className={styles.customInput} value={inputValue} name="name" placeholder={$t('Set a title for your recording')} onChange={handleInputChange} style={{ width: '100%', color: 'black', border: 'none' }} rules={[specialCharacterValidator]} nowrap/>
          <div onClick={() => __awaiter(this, void 0, void 0, function* () {
            ...
            {filePath ? (<video src={filePath} controls></video>) : (<div onDrop={(e) => { }} style={{ display: 'grid', placeItems: 'center' }}>
                <i className="fa fa-plus" style={{ color: draggingOver ? 'var(--teal)' : 'inherit' }}></i>
                <h3 className={styles.dragAndDrop} style={{
          ...
          <Form>
            ...
            <ListInput onSelect={(val, opts) => {
            onSelect(opts.value);
        }} onChange={value => {
            setGame(value || null);
        }} placeholder={$t('Start typing to search')} options={gameOptions} defaultValue={game} showSearch optionRender={option => (<div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  {option.image && (<img src={typeof option.image === 'string' ? option.image : undefined} alt={option.label} className={styles.listImage}/>)}
                  <span>{option.label}</span>
                  <span style={{ fontSize: '12px', opacity: '0.5' }}>{option.description}</span>
                </div>)} debounce={500} allowClear/>
          </Form>

          <div style={{ display: 'flex', gap: '8px' }}>
            {openedFrom === 'after-stream' && (<Button size="large" style={{ width: '100%', marginTop: '4px' }} type="default" onClick={() => closeModal(true)}>
                {$t('Cancel')}
              </Button>)}

            <Button disabled={!game} size="large" style={{
            width: '100%',
            marginTop: '4px',
        ...
        }} type="primary" onClick={() => startAiDetection(inputValue, game, filePath ? [filePath] : undefined, streamInfo === null || streamInfo === void 0 ? void 0 : streamInfo.id)}>
...
//# sourceMappingURL=ImportStream.jsx.map