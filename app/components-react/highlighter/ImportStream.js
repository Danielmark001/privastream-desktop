...
export function ImportStreamModal({ close, openedFrom, videoPath, selectedGame, streamInfo, }) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r;
    const { HighlighterService, UsageStatisticsService } = Services;
    const [inputValue, setInputValue] = useState((streamInfo === null || streamInfo === void 0 ? void 0 : streamInfo.title) || '');
    const [filePath, setFilePath] = useState(videoPath);
    const [draggingOver, setDraggingOver] = useState(false);
    const [game, setGame] = useState(((streamInfo === null || streamInfo === void 0 ? void 0 : streamInfo.game) !== EGame.UNSET ? streamInfo === null || streamInfo === void 0 ? void 0 : streamInfo.game : selectedGame) ||
        selectedGame ||
        undefined);
    ...
    function importStreamFromDevice() {
    ...
    function closeModal(trackAsCanceled) {
        if (trackAsCanceled) {
    ...
    function startAiDetection(title, game, filePath, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const streamInfo = {
                id: id !== null && id !== void 0 ? id : 'manual_' + uuid(),
            ...
            try {
                ...
                filePath = yield importStreamFromDevice();
    ...
    const [artwork, setArtwork] = useState((_a = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _a === void 0 ? void 0 : _a.artwork);
    const [isAnimating, setIsAnimating] = useState(false);
    useEffect(() => {
        var _a;
        if (((_a = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _a === void 0 ? void 0 : _a.artwork) !== artwork) {
            setIsAnimating(true);
            setTimeout(() => {
                var _a;
                setArtwork((_a = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _a === void 0 ? void 0 : _a.artwork);
                setIsAnimating(false);
            }, 200);
        }
    }, [(_b = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _b === void 0 ? void 0 : _b.artwork]);
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: cx(styles.hypeWrapper, (gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) && styles.hypeWrapperWithImportConfig), style: {
                backgroundColor: ((_c = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _c === void 0 ? void 0 : _c.backgroundColor) || 'var(--section)',
            } },
            React.createElement("div", { className: styles.hypeContent },
                React.createElement("img", { className: `${styles.artworkImage} ${isAnimating ? styles.fadeOut : styles.fadeIn}`, src: artwork, alt: "" }),
                React.createElement("div", { className: styles.overlay }),
                React.createElement("div", { className: styles.coloredBlob, style: {
                        backgroundColor: `${(_d = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _d === void 0 ? void 0 : _d.accentColor}`,
                    } }),
                React.createElement("div", { className: styles.contentDivider },
                    React.createElement("div", { className: styles.leftWrapper },
                        React.createElement("div", { className: styles.headerWrapper },
                            React.createElement("h2", { className: styles.hypeContentHeadline }, $t('Turn your gameplay into epic highlight reels')),
                            React.createElement("h2", { className: styles.hypeContentSubheadline }, $t('Dominate, showcase, inspire!'))),
                        ((_e = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _e === void 0 ? void 0 : _e.horizontalExampleVideo) &&
                            ((_f = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _f === void 0 ? void 0 : _f.verticalExampleVideo) && (React.createElement("div", { style: { position: 'relative' } },
                            React.createElement("div", { className: styles.plattformIcon, style: { top: '42px', left: '160px' } },
                                React.createElement(YouTubeLogo, null)),
                            React.createElement("div", { className: styles.plattformIcon, style: { top: '182px', left: '32px' } },
                                React.createElement(DiscordLogo, null)),
                            React.createElement("div", { className: styles.plattformIcon, style: { top: '243px', left: '290px' } },
                                React.createElement(TikTokLogo, null)),
                            React.createElement("div", { className: styles.plattformIcon, style: { top: '283px', left: '153px' } },
                                React.createElement(InstagramLogo, null)),
                            React.createElement("div", { className: styles.horizontalVideo, style: {
                                    backgroundColor: (_g = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _g === void 0 ? void 0 : _g.backgroundColor,
                                    borderColor: (_h = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _h === void 0 ? void 0 : _h.accentColor,
                                    boxShadow: `0px 0px 42px -4px ${(_j = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _j === void 0 ? void 0 : _j.accentColor}30`,
                                } },
                            ...
                            React.createElement("div", { className: styles.verticalVideo, style: {
                                    backgroundColor: (_k = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _k === void 0 ? void 0 : _k.backgroundColor,
                                    borderColor: (_l = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _l === void 0 ? void 0 : _l.accentColor,
                                    boxShadow: `0px 0px 42px -4px ${(_m = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _m === void 0 ? void 0 : _m.accentColor}30`,
                                } },
                                ' ',
                                React.createElement("video", { muted: true, autoPlay: true, loop: true, style: { height: '100%' }, src: gameConfig.importModalConfig.verticalExampleVideo }))))),
                    React.createElement("div", null),
                    React.createElement("div", null))),
            React.createElement("div", { className: styles.manualUploadWrapper, style: {
                    borderColor: ((_o = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _o === void 0 ? void 0 : _o.accentColor) &&
                        `${(_p = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _p === void 0 ? void 0 : _p.accentColor}40`,
                } },
                React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between' } },
                    React.createElement("h2", { style: { fontWeight: 600, margin: 0 } }, openedFrom === 'after-stream' ? 'Ai Highlighter' : `${$t('Import Game Recording')}`),
                    ' ',
                    React.createElement("div", null,
                        React.createElement(Button, { type: "text", onClick: () => closeModal(true) },
                            React.createElement("i", { className: "icon-close", style: { margin: 0 } })))),
                React.createElement(TextInput, { className: styles.customInput, value: inputValue, name: "name", placeholder: $t('Set a title for your recording'), onChange: handleInputChange, style: { width: '100%', color: 'black', border: 'none' }, rules: [specialCharacterValidator], nowrap: true }),
                React.createElement("div", { onClick: () => __awaiter(this, void 0, void 0, function* () {
                        const path = yield importStreamFromDevice();
                        ...
                        e.preventDefault();
                        e.stopPropagation();
                    }, onDragLeave: () => setDraggingOver(false), className: styles.videoPreview, style: {
                        '--border-style': filePath ? 'solid' : 'dashed',
                        '--border-color': draggingOver ? 'var(--teal)' : 'var(--midtone)',
                        cursor: 'pointer',
                    } }, filePath ? (React.createElement("video", { src: filePath, controls: true })) : (React.createElement("div", { onDrop: (e) => { }, style: { display: 'grid', placeItems: 'center' } },
                    React.createElement("i", { className: "fa fa-plus", style: { color: draggingOver ? 'var(--teal)' : 'inherit' } }),
                    React.createElement("h3", { className: styles.dragAndDrop, style: {
                ...
                React.createElement(Form, null,
                    ...
                    React.createElement(ListInput, { onSelect: (val, opts) => {
                            onSelect(opts.value);
                        }, onChange: value => {
                            setGame(value || null);
                        }, placeholder: $t('Start typing to search'), options: gameOptions, defaultValue: game, showSearch: true, optionRender: option => (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                            option.image && (React.createElement("img", { src: typeof option.image === 'string' ? option.image : undefined, alt: option.label, className: styles.listImage })),
                            React.createElement("span", null, option.label),
                            React.createElement("span", { style: { fontSize: '12px', opacity: '0.5' } }, option.description))), debounce: 500, allowClear: true })),
                React.createElement("div", { style: { display: 'flex', gap: '8px' } },
                    openedFrom === 'after-stream' && (React.createElement(Button, { size: "large", style: { width: '100%', marginTop: '4px' }, type: "default", onClick: () => closeModal(true) }, $t('Cancel'))),
                    React.createElement(Button, { disabled: !game, size: "large", style: {
                            width: '100%',
                            marginTop: '4px',
                            backgroundColor: (_q = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _q === void 0 ? void 0 : _q.accentColor,
                            borderColor: (_r = gameConfig === null || gameConfig === void 0 ? void 0 : gameConfig.importModalConfig) === null || _r === void 0 ? void 0 : _r.accentColor,
                        }, type: "primary", onClick: () => startAiDetection(inputValue, game, filePath ? [filePath] : undefined, streamInfo === null || streamInfo === void 0 ? void 0 : streamInfo.id) }, filePath ? $t('Find game highlights') : $t('Select video and start import')))))));
}
export function YouTubeLogo() {
    return (React.createElement("svg", { width: "35", height: "28", viewBox: "0 0 35 28", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("rect", { x: "9.1709", y: "7.53497", width: "14.7901", height: "11.3769", transform: "rotate(-1.90445 9.1709 7.53497)", fill: "white" }),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7.35408 26.1424C15.208 25.1663 22.9461 23.7506 30.637 21.883C32.1247 21.5045 33.2901 19.9448 33.1854 18.4049C32.7769 13.2709 31.8611 8.26517 30.4255 3.31908C29.9783 1.84181 28.3361 0.795762 26.8108 0.968515C18.9569 1.9447 11.2187 3.36034 3.52791 5.22796C2.04019 5.60643 0.874717 7.16612 0.979506 8.70603C1.38796 13.84 2.30373 18.8458 3.73937 23.7919C4.18655 25.2692 5.82873 26.3152 7.35408 26.1424ZM22.0544 12.2913L13.1618 9.52437L14.7174 18.0273L22.0544 12.2913Z", fill: "#EA3223" })));
}
