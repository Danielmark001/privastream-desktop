...
export default function ClipPreviewInfo({ clip, game, }) {
    var _a;
    if (!clip || !clip.aiInfo) {
        return React.createElement("span", null, "No event data");
    }
    ...
    return (React.createElement("div", { style: {
        ...
        eventDisplays.map((event, index) => {
            return React.createElement(React.Fragment, { key: index }, event.emoji);
        }),
        ((_a = clip.aiInfo.metadata) === null || _a === void 0 ? void 0 : _a.round) && (React.createElement("div", { className: styles.roundTag }, `Round: ${clip.aiInfo.metadata.round}`)),
        ' '));
}
//# sourceMappingURL=ClipPreviewInfo.js.map