...
export default function ClipTrimmer(props) {
    ...
    return (<div>
      <video ref={videoRef} src={props.clip.path.replace('#', '%23')} style={{ borderRadius: 5 }} width="100%" onEnded={() => {
            setIsPlaying(false);
      ...
      <div ref={timelineRef} style={{
        ...
        <div style={{ display: 'flex', overflow: 'hidden', position: 'absolute' }}>
          {scrubFrames.map(frame => {
            var _a;
            return (<img key={frame} src={(_a = props.clip.scrubSprite) === null || _a === void 0 ? void 0 : _a.replace('#', '%23')} width={SCRUB_WIDTH} height={SCRUB_HEIGHT} style={{
                    height: scrubHeight,
                    width: scrubWidth,
                    objectFit: 'cover',
        ...
        }} className={cx(styles.clipPlayhead, { [styles.clipPlayheadPlaying]: isPlaying.current })}></div>
...
//# sourceMappingURL=ClipTrimmer.jsx.map