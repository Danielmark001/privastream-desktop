...
export default function TransitionSelector() {
    ...
    function getTransitionBlock(transition) {
        ...
        return (<div style={{ textAlign: 'center', fontSize: 11, cursor: 'pointer' }} onClick={() => HighlighterService.actions.setTransition({ type: transition.type })} key={transition.type}>
        <div style={{
                width: 52,
                height: 52,
    ...
    return (<InputWrapper label="Transition Type">
...
//# sourceMappingURL=TransitionSelector.jsx.map