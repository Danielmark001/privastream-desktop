...
export default function RemoveModal(p) {
    ...
    return (<div style={{ textAlign: 'center' }}>
      ...
      <div style={{ position: 'relative', height: `${SCRUB_HEIGHT}px`, marginTop: '32px' }}>
        {clipsToDelete.slice(0, 3).map((clip, index) => (<React.Fragment key={clip.path}>
        ...
        {clipsToDelete.length > 1 && (<span className={styles.selectedForDeletion}>
      ...
      <div>
        <Checkbox style={{ marginBottom: '24px' }} checked={deleteAllSelected} onChange={e => {
...
//# sourceMappingURL=RemoveModal.jsx.map