...
export default function HelpTip(props) {
    ...
    if (!shouldShow)
        return <></>;
    return (<div className={styles.helpTip} style={p.position}>
      {p.arrowPosition === 'top' && (<div className={cx(styles.helpTipArrow, {
      ...
      {p.arrowPosition === 'bottom' && (<div className={cx(styles.helpTipArrow, styles.helpTipArrowBottom, {
                [styles.helpTipArrowRight]: p.tipPosition === 'right',
            })}/>)}
    </div>);
}
//# sourceMappingURL=HelpTip.jsx.map