...
export default function DismissableBadge({ content = 'New', dismissableKey, size = 'standard', absolute = false, style, className, }) {
    ...
    if (!shouldShow)
        return <></>;
    return (<div className={cx(className, styles.badge, styles.dismissableBadge, { [styles.absolute]: absolute }, { [styles.small]: size === 'small' })} style={style}>
      {typeof content === 'string' ? $t(content) : content}
    </div>);
}
//# sourceMappingURL=DismissableBadge.jsx.map