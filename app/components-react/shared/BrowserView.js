...
export default function BrowserView(p) {
    ...
    if (loading) {
        return (React.createElement("div", { style: {
            ...
            React.createElement(Spinner, { visible: true, pageLoader: true })));
    }
    ...
    return React.createElement("div", { style: Object.assign({ height: '100%' }, p.style), ref: sizeContainer, className: p.className });
}
