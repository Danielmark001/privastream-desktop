...
export default function Spinner(props = {}) {
    ...
    return (React.createElement(Animation, { transitionName: "ant-fade" }, visibility.isContainerVisible && (React.createElement("div", { className: classNames, key: "spinner", style: { transitionDelay: `${p.delay}ms` } },
        React.createElement("div", { className: css.spinner, dangerouslySetInnerHTML: { __html: spinnerSvg } })))));
}
