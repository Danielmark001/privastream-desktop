...
export const DisplayToggle = forwardRef((p, ref) => {
    ...
    const verticalDisabled = useMemo(() => {
        if (p === null || p === void 0 ? void 0 : p.disabled)
            return true;
    ...
    function toggleDisplay(display, isActive) {
    ...
    return (React.createElement("div", { "data-name": p === null || p === void 0 ? void 0 : p.name, className: cx(p === null || p === void 0 ? void 0 : p.className, styles.displayToggleContainer), style: p.style, ref: ref },
        React.createElement(Tooltip, { id: "toggle-horizontal-tooltip", title: horizontalTooltip, className: styles.displayToggle, placement: placement, disabled: p === null || p === void 0 ? void 0 : p.disabled },
            React.createElement("i", { id: "horizontal-display-toggle", onClick: e => {
                    if (p === null || p === void 0 ? void 0 : p.disabled) {
                        e.stopPropagation();
                        return;
                    }
        ...
        React.createElement(Tooltip, { id: "toggle-vertical-tooltip", title: verticalTooltip, className: styles.displayToggle, placement: placement, disabled: verticalDisabled },
            React.createElement("i", { id: "vertical-display-toggle", onClick: e => {
                    if (verticalDisabled) {
                        e.stopPropagation();
                        return;
                    }
...
//# sourceMappingURL=DisplayToggle.js.map