...
export default function PlatformLogo(p) {
    ...
    return (<>
      {(p === null || p === void 0 ? void 0 : p.fontIcon) ? (<i className={cx(`icon-${p === null || p === void 0 ? void 0 : p.fontIcon}`, p.className)} style={style}/>) : (<i className={cx(iconForPlatform(), !p.nocolor && css[p.platform], p.className, {
...
//# sourceMappingURL=PlatformLogo.jsx.map