...
export default function PlatformAppPageView(p) {
    ...
    return (React.createElement(React.Fragment, null,
        delisted && (React.createElement("div", { onClick: goToUninstall, className: styles.delistContainer },
        ...
        React.createElement("div", { style: Object.assign({ display: !hideStyleBlockers ? 'flex' : 'none', flexDirection: 'column', width: '100%' }, p.style), className: p.className, ref: appContainer })));
}
//# sourceMappingURL=PlatformAppPageView.js.map