...
export default function DualOutputToggle(p) {
    ...
    return (<div className={cx(p === null || p === void 0 ? void 0 : p.className, styles.dualOutputToggle, {
            [styles.doTooltip]: p.type === 'dual',
            [styles.soTooltip]: p.type === 'single',
        })} style={p === null || p === void 0 ? void 0 : p.style}>
      <CheckboxInput id="dual-output-checkbox" name="dual-output-checkbox" data-name="dual-output-checkbox" label={(_c = p === null || p === void 0 ? void 0 : p.label) !== null && _c !== void 0 ? _c : defaultLabel} value={value} onChange={toggleDualOutput} className={cx(styles.doCheckbox, p === null || p === void 0 ? void 0 : p.checkboxClassname)} disabled={p === null || p === void 0 ? void 0 : p.disabled}/>
      <Tooltip title={$t('Stream to horizontal and vertical platforms simultaneously. Recordings will be in horizontal only.')} className={styles.doTooltip} placement={placement} lightShadow={p === null || p === void 0 ? void 0 : p.lightShadow} disabled={p === null || p === void 0 ? void 0 : p.tooltipDisabled}>
...
function showSelectiveRecordingModal() {
    alertAsync({
        ...
        closable: true,
        content: (<span>
        {$t('Selective Recording only works with horizontal sources and disables editing the vertical output scene. Please disable Selective Recording to go live with Dual Output.')}
      </span>),
        cancelText: $t('Close'),
        okText: $t('Disable'),
...
function showStudioModeModal() {
    alertAsync({
        ...
        closable: true,
        content: (<span>
        {$t('Cannot toggle Dual Output while in Studio Mode. Please disable Studio Mode to go live with Dual Output.')}
      </span>),
        cancelText: $t('Close'),
        okText: $t('Disable'),
        okButtonProps: { type: 'primary' },
...
//# sourceMappingURL=DualOutputToggle.jsx.map