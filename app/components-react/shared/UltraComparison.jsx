...
export function UltraComparison(p) {
    ...
    return (<div style={{
      ...
      <div className={cx(styles.cardContainer, { [styles.condensed]: p.condensed })} onClick={p.onSkip}>
        <div className={styles.header}>
          ...
          <div className={styles.features}>
            {featureData.standard.map(data => (<div key={data.text} className={styles.row}>
      ...
      <div className={cx(styles.cardContainer, styles.primeCardContainer, {
        ...
        <div className={styles.header}>
          ...
          <div className={styles.subheader}>
            ...
            {shouldDisplayPrices ? (<span>
                {$t('%{monthlyPrice}/mo or %{yearlyPrice}/year', {
                monthlyPrice: '$19',
                yearlyPrice: '$149',
            })}
              </span>) : (<span style={{ marginBottom: '18px' }}/>)}
          </div>
        ...
        <div className={styles.features}>
          {featureData.ultra.map(data => (<div className={styles.row} key={data.text}>
              {data.icon && <i className={data.icon}/>}
              <span>{data.text}</span>
            </div>))}
        </div>
...
//# sourceMappingURL=UltraComparison.jsx.map