...
export const FileInput = InputComponent((p) => {
    ...
    return (React.createElement(InputWrapper, Object.assign({}, wrapperAttrs),
        React.createElement(Input, Object.assign({}, inputAttrs, { onChange: val => inputAttrs === null || inputAttrs === void 0 ? void 0 : inputAttrs.onChange(val.target.value), value: p.value, disabled: true, addonAfter: React.createElement(Button, { style: p.buttonContent ? { borderRadius: '4px' } : {}, onClick: handleShowFileDialog }, p.buttonContent || $t('Browse')) }))));
});
