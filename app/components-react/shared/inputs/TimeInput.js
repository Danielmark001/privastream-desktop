...
export const TimeInput = InputComponent((p) => {
    ...
    return (React.createElement(InputWrapper, Object.assign({}, wrapperAttrs),
        React.createElement(TimePicker, Object.assign({}, inputAttrs, { ref: inputRef, value: value, onSelect: onChange, onChange: onChange, use12Hours: true, format: "h:mm a", showNow: false, allowClear: false }))));
});
