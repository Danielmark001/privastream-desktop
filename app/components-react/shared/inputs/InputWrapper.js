...
export default InputComponent(function InputWrapper(p) {
    ...
    return p.nowrap ? (React.createElement(React.Fragment, null, p.children)) : (React.createElement(Form.Item, Object.assign({ colon: false }, layoutPreset, formItemProps, { label: label }), formItemProps.children));
});
