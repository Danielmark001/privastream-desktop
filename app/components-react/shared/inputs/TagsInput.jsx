...
export const TagsInput = InputComponent((p) => {
    ...
    function dropdownRender(menu) {
        ...
        return (<div>
        {maxTagsReached && (<Message type="warning">
