...
export const AnimationInput = InputComponent((p) => {
    function listInputMetadata() {
        switch (p.filter) {
            case 'in':
                return Object.assign(Object.assign({}, p), { options: inAnimations() });
            case 'out':
                return Object.assign(Object.assign({}, p), { options: outAnimations() });
            case 'text':
                return Object.assign(Object.assign({}, p), { options: textAnimations() });
            case 'eventIn':
                return Object.assign(Object.assign({}, p), { options: eventInAnimations() });
            case 'eventOut':
                return Object.assign(Object.assign({}, p), { options: eventOutAnimations() });
            default:
                return Object.assign(Object.assign({}, p), { options: textAnimations().concat(inAnimations()).concat(outAnimations()) });
        }
    }
    return React.createElement(ListInput, Object.assign({}, listInputMetadata()));
});
//# sourceMappingURL=AnimationInput.js.map