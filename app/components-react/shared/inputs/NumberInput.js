...
export const NumberInput = React.memo((p) => {
    ...
    return (React.createElement(InputWrapper, Object.assign({}, wrapperAttrs, { rules: [Object.assign(Object.assign({}, rules), { type: 'number' })] }),
        React.createElement(InputNumber, Object.assign({}, inputAttrs, { onChange: onChangeHandler, defaultValue: p.defaultValue }))));
});
