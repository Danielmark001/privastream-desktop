...
export const ImageInput = InputComponent((p) => {
    ...
    return (React.createElement(InputWrapper, Object.assign({}, wrapperAttrs),
        React.createElement(Upload, Object.assign({}, inputAttrs, { accept: "image/png, image/jpeg", listType: "picture-card", fileList: (fileInfo.url && [fileInfo]) || [], beforeUpload: onBeforeUploadHandler, onPreview: onPreviewHandler, onRemove: onRemoveHandler, customRequest: () => null, onChange: () => null }), !p.value && '+ Upload'),
        React.createElement(Modal, { visible: isPreviewVisible, title: $t('Preview'), footer: null, onCancel: () => setPreviewVisible(false) },
            React.createElement("img", { style: { width: '100%' }, src: p.value })),
