...
export function ColorInput(p) {
    ...
    const picker = typeof inputAttrs.value === 'string' ? (React.createElement(HexColorPicker, { color: inputAttrs.value, onChange: inputAttrs.onChange })) : (React.createElement(RgbaColorPicker, { color: inputAttrs.value, onChange: inputAttrs.onChange }));
    return (React.createElement(InputWrapper, Object.assign({}, wrapperAttrs),
        React.createElement(Popover, { content: picker, trigger: "click", placement: "bottomLeft", getPopupContainer: getPopupContainer, overlayStyle: { marginTop: '-20px' } },
            React.createElement(Input, Object.assign({}, divAttrs, { value: textInputVal, onChange: onTextInputChange, onBlur: onTextInputBlur, onKeyDown: handleKeyDown, ref: ref, prefix: React.createElement("span", { style: { width: '22px' } },
                    React.createElement("div", { style: {
                            ...
                            width: '26px',
                            top: '2px',
                        } })), addonAfter: getOS() === OS.Windows ? (React.createElement(Button, { title: $t('Pick Screen Color'), style: { padding: '4px 9px' }, onClick: eyedrop },
                    React.createElement("i", { className: "fas fa-eye-dropper" }))) : (false) })))));
}
