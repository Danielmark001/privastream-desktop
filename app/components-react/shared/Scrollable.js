...
export default function Scrollable(initialProps) {
    ...
    return (React.createElement(OverlayScrollbarsComponent, { style: Object.assign(Object.assign({}, p.style), wrapperStyles), options: {
            autoUpdate: true,
        ...
        }, onContextMenu: p.onContextMenu }, p.children));
}
