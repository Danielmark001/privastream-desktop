...
export default function HotkeyBinding(p) {
    ...
    const hotKeyLabel = p.showLabel !== false ? React.createElement(HotkeyLabel, null) : React.createElement(React.Fragment, null);
    ...
    function HotkeyLabel() {
        if (!p.hotkey.isMarker)
            return React.createElement(React.Fragment, null, p.hotkey.description || '');
        return (React.createElement(TextInput, { value: MarkersService.views.getLabel(p.hotkey.actionName), onChange: handleLabel, nowrap: true }));
    }
    function DualOutputHotkeyLabel() {
        ...
        if (!p.hotkey.isMarker) {
            return (React.createElement(React.Fragment, null,
                React.createElement("i", { className: icon, style: { margin: '5px', opacity: 0.6 } }),
                p.hotkey.description || ''));
        }
        return (React.createElement(React.Fragment, null,
            React.createElement("i", { className: icon, style: { margin: '5px', opacity: 0.6 } }),
            React.createElement(TextInput, { value: MarkersService.views.getLabel(p.hotkey.actionName), onChange: handleLabel, nowrap: true })));
    }
    return (React.createElement(Form, { layout: "inline" },
        React.createElement(TextInput, { name: "binding", style: Object.assign({ width: 400 }, p.style), label: showDualOutputLabel ? React.createElement(DualOutputHotkeyLabel, null) : hotKeyLabel, value: getHotkeyString(p.binding, focused), onFocus: () => setFocused(true), onBlur: () => setFocused(false), onKeyDown: handlePress, onMouseDown: handleClick, inputRef: inputRef })));
}
//# sourceMappingURL=HotkeyBinding.js.map