...
export default function Display(props) {
    ...
    return (React.createElement("div", { id: p === null || p === void 0 ? void 0 : p.id, className: "display", ref: displayEl, style: Object.assign({ height: '100%', backgroundColor: 'var(--section)', flexGrow: 1 }, p.style), onClick: onClickHandler }));
}
