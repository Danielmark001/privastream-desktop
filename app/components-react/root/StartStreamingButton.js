...
export default function StartStreamingButton(p) {
    ...
    return (React.createElement("button", { style: { minWidth: '130px' }, className: cx('button button--action', { 'button--soft-warning': getIsRedButton }), disabled: isDisabled, onClick: toggleStreaming, "data-name": "StartStreamingButton" }, isLoading ? (React.createElement("i", { className: "fa fa-spinner fa-pulse" })) : (React.createElement(StreamButtonLabel, { streamingStatus: streamingStatus, delayEnabled: delayEnabled, delaySecondsRemaining: delaySecondsRemaining, streamShiftStatus: streamShiftStatus }))));
}
...
//# sourceMappingURL=StartStreamingButton.js.map