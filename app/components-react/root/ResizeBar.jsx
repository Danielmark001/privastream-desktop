...
export default function ResizeBar(p) {
    ...
    return (<Resizable onResizeStart={handleResize(resizeStart)} onResizeStop={handleResize(resizeStop)} onResize={handleResize(p.onInput)} transformScale={(_a = p.transformScale) !== null && _a !== void 0 ? _a : 2} {...resizableProps} handle={<div className={cx(styles.resizeBar, styles[p.position], p.className, {
...
//# sourceMappingURL=ResizeBar.jsx.map