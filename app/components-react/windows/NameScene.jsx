...
export default function NameScene() {
    ...
    return (<ModalLayout onOk={submit} okText={$t('Done')}>
      <Form layout="vertical" form={form} name="nameSceneForm" onFinish={() => submit()}>
        <TextInput label={$t('Please enter the name of the scene')} name="sceneName" value={name} onInput={v => setName(v)} required={true} uncontrolled={false} autoFocus/>
      </Form>
    </ModalLayout>);
}
//# sourceMappingURL=NameScene.jsx.map