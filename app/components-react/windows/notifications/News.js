...
export default function News() {
    ...
    return (React.createElement(Scrollable, { style: { height: 'calc(93vh - 100px)' }, snapToWindowEdge: true }, newsItems.map(item => (React.createElement("div", { className: styles.newsItemContainer, key: item.id },
        React.createElement("img", { className: styles.newsImage, src: item.thumbnail }),
        React.createElement("h4", null, item.header),
        React.createElement("span", null, item.subHeader),
        React.createElement("button", { className: "button button--action", onClick: handleClick(item) }, item.linkTitle))))));
}
