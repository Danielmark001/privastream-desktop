...
export default function WelcomeToPrime() {
    ...
    return (<div className={styles.container}>
      ...
      <div className={styles.panelContainer}>
        {panelData.map(panel => (<Panel panel={panel} key={panel.link}/>))}
      </div>
...
function Panel(p) {
    ...
    return (<div className={styles.panel}>
      ...
      <button className="button button--action" onClick={() => navigate(p.panel.link)}>
        {p.panel.button}
      </button>
    </div>);
}
//# sourceMappingURL=WelcomeToPrime.jsx.map