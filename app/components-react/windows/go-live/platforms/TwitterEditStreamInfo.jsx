...
export function TwitterEditStreamInfo(p) {
    ...
    return (<Form name="twitter-settings">
      <PlatformSettingsLayout layoutMode={p.layoutMode} commonFields={<CommonPlatformFields key="common" platform="twitter" layoutMode={p.layoutMode} value={twSettings} onChange={updateSettings} layout={p.layout}/>} requiredFields={<div key="required">
            <ListInput {...bind.chatType} label={$t('X (Twitter) Chat Type')} options={[
                {
...
//# sourceMappingURL=TwitterEditStreamInfo.jsx.map