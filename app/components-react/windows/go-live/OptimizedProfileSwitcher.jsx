...
export default function OptimizedProfileSwitcher() {
    ...
    return (<InputWrapper>
      ...
      {!optimizedProfileQuery.isLoading && (<CheckboxInput value={enabled} onChange={setEnabled} label={label} tooltip={tooltip}/>)}
    </InputWrapper>);
}
//# sourceMappingURL=OptimizedProfileSwitcher.jsx.map