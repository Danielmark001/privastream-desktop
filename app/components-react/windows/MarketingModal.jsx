    ...
    return (<ModalLayout>
      ...
      <div className={cx(styles.cell, styles.main)}>
        ...
        <div className={styles.info}>
          ...
          <button className="button button--action" onClick={() => handleButton(productUpdates[0].link)}>
      ...
      <div className={styles.subUpdates}>
        {productUpdates[1] && (<div className={styles.cell}>
            <div className={styles.imageContainer}>
            ...
            <div className={styles.info}>
              ...
              <button className="button button--default" onClick={() => handleButton(productUpdates[1].link)}>
                {productUpdates[1].linkTitle}
              </button>
            </div>
          </div>)}
        {productUpdates[2] && (<div className={styles.cell}>
            <div className={styles.imageContainer}>
            ...
            <div className={styles.info}>
              ...
              <button className="button button--default" onClick={() => handleButton(productUpdates[2].link)}>
...
//# sourceMappingURL=MarketingModal.jsx.map