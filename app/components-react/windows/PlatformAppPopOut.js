...
export default function PlatformAppPopOut() {
    ...
    useEffect(() => {
        const subscription = PlatformAppsService.appUnload.subscribe(appId => {
            if (appId === (params === null || params === void 0 ? void 0 : params.appId)) {
                WindowsService.actions.closeOneOffWindow(windowId);
            }
        });
        return subscription.unsubscribe;
    }, []);
    return (React.createElement(PlatformAppPageView, { appId: params.appId, pageSlot: params.pageSlot, style: { height: 'calc(100% - 30px)', width: '100%' } }));
}
//# sourceMappingURL=PlatformAppPopOut.js.map