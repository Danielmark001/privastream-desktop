...
export function DemoForm() {
    ...
    return (<Form layout={layout} name="demo-form">
      <Example title="Demo Form">
        ...
        <ListInput {...bind.city} label={'City'} placeholder="Start typing for search" options={citiesQuery.data} showSearch onSearch={search => setSearchStr(search)} loading={citiesQuery.isLoading}/>
...
//# sourceMappingURL=DemoForm.jsx.map