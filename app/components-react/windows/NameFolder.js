...
export default function NameFolder() {
    ...
    return (React.createElement(ModalLayout, { onOk: submit },
        React.createElement(Form, { layout: "vertical", form: form, onFinish: submit },
            React.createElement(TextInput, { name: "name", value: name, onInput: v => setName(v), label: $t('Please enter the name of the folder'), required: true, uncontrolled: false, autoFocus: true }))));
}
//# sourceMappingURL=NameFolder.js.map