...
export function SceneCollectionsSettings() {
    ...
    function Button(p) {
        return (React.createElement(AntButton, { onClick: p.onClick, type: "primary" },
            p.children,
            busy && React.createElement("i", { className: "fa fa-spinner fa-pulse", style: { marginLeft: '5px' } })));
    }
    return (React.createElement(React.Fragment, null,
        React.createElement(ObsSettingsSection, null,
            React.createElement("div", { style: { display: 'flex', justifyContent: 'space-evenly', paddingBottom: '16px' } },
                React.createElement(Button, { onClick: createSceneCollection }, $t('Create Scene Collection')),
                React.createElement(Button, { onClick: loadWidget }, $t('Import Widget File in Current Scene')))),
        React.createElement(ObsSettingsSection, null,
            React.createElement("p", null, $t('This feature is intended for overlay designers to export their work for our Overlay Library. Not all sources will be exported, use at your own risk.')),
            React.createElement("div", { style: { display: 'flex', justifyContent: 'space-evenly', paddingBottom: '16px' } },
                React.createElement(Button, { onClick: saveOverlay }, $t('Export Overlay File')),
                React.createElement(Button, { onClick: loadOverlay }, $t('Import Overlay File'))),
            React.createElement(SwitchInput, { label: $t('Enable Designer Mode'), value: designerMode, onChange: setDesignerMode }),
            message),
        React.createElement(ObsSettingsSection, null,
            React.createElement(CheckboxInput, { label: $t('Do not back up my media files in the cloud (requires app restart)'), value: mediaBackupOptOut, onChange: setMediaBackupOptOut })),
        React.createElement(ObsSettingsSection, { title: $t('Manage Dual Output Scene') },
            React.createElement(ListInput, { label: $t('Scene Collection'), value: collection, onChange: setCollection, options: collectionOptions }),
            React.createElement(DualOutputDeveloperSettings, { collection: collection }))));
}
//# sourceMappingURL=SceneCollections.js.map