...
export function OutputSettings() {
    ...
    return (<div className="form-groups" style={{ paddingBottom: '12px' }}>
      ...
      {type === 'collapsible' && (<ObsCollapsibleFormGroup sections={sections} onChange={onChange}/>)}
    </div>);
}
export function ObsTabbedOutputFormGroup(p) {
    ...
    return (<div className="section" key="tabbed-section" style={{ marginBottom: '24px' }}>
      {p.sections.map((sectionProps, ind) => (<div className="section-content" key={`${sectionProps.nameSubCategory}${ind}`}>
          ...
          {currentTab === 'Audio' && sectionProps.nameSubCategory.startsWith('Audio - Track') && (<div style={{
...
//# sourceMappingURL=Output.jsx.map