...
export default function SourceProperties() {
    ...
    return (<ModalLayout scrollable fixedChild={source && <Display sourceId={source.sourceId} style={{ position: 'relative' }}/>}>
      <ObsForm value={properties} onChange={onChangeHandler} extraProps={extraProps} layout="horizontal"/>
    </ModalLayout>);
}
//# sourceMappingURL=SourceProperties.jsx.map