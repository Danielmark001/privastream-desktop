...
export default function RenameSource() {
    ...
    return (<ModalLayout onOk={submit} okText={$t('Done')}>
      <Form layout="vertical" form={form} name="renameSourceForm" onFinish={() => submit()}>
        <TextInput label={$t('Please enter the name of the source')} name="sourceName" data-role="input" data-type="text" value={name} onInput={setName} uncontrolled={false} required autoFocus/>
      </Form>
    </ModalLayout>);
}
//# sourceMappingURL=RenameSource.jsx.map