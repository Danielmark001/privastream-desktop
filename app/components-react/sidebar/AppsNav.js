...
export default function AppsNav(p) {
    ...
    return type === 'selected' ? (React.createElement(React.Fragment, null, apps.map(app => app &&
        (app === null || app === void 0 ? void 0 : app.isActive) && (React.createElement(MenuItem, { key: app === null || app === void 0 ? void 0 : app.id, className: cx(!isOpen && styles.closed, isOpen && styles.open, currentMenuItem === (app === null || app === void 0 ? void 0 : app.id) && styles.active), title: app === null || app === void 0 ? void 0 : app.name, icon: (app === null || app === void 0 ? void 0 : app.icon) && (app === null || app === void 0 ? void 0 : app.id) ? (React.createElement("img", { src: iconSrc(app === null || app === void 0 ? void 0 : app.id, app === null || app === void 0 ? void 0 : app.icon), className: styles.appIcons })) : (React.createElement("i", { className: "icon-integrations" })), onClick: () => (app === null || app === void 0 ? void 0 : app.id) && navigateApp(app === null || app === void 0 ? void 0 : app.id), type: "app", onContextMenu: e => showContextMenu(e, app === null || app === void 0 ? void 0 : app.id), draggable: true, onDragEnd: () => popOut(app === null || app === void 0 ? void 0 : app.id) }, app === null || app === void 0 ? void 0 : app.name))))) : (React.createElement(React.Fragment, null, enabledApps.map(app => {
        var _a, _b;
        return app && (React.createElement(MenuItem, { key: `sub-${app === null || app === void 0 ? void 0 : app.id}`, className: cx(styles.appMenuItem, currentMenuItem === `sub-${app === null || app === void 0 ? void 0 : app.id}` && styles.active), title: (_a = app.manifest) === null || _a === void 0 ? void 0 : _a.name, onClick: () => {
            ...
            }, type: "submenu", onContextMenu: e => showContextMenu(e, app === null || app === void 0 ? void 0 : app.id), draggable: true, onDragEnd: () => popOut(app === null || app === void 0 ? void 0 : app.id) }, (_b = app.manifest) === null || _b === void 0 ? void 0 : _b.name));
    })));
}
//# sourceMappingURL=AppsNav.js.map