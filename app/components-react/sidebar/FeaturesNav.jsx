...
export default function FeaturesNav() {
    ...
    return (<Menu key={ENavName.TopNav} forceSubMenuRender mode="inline" className={cx(styles.topNav, isOpen && styles.open, !isOpen && styles.siderClosed && styles.closed)} defaultOpenKeys={openMenuItems && openMenuItems} defaultSelectedKeys={[EMenuItemKey.Editor]} getPopupContainer={triggerNode => triggerNode}>
      {menuItems.map((menuItem) => {
            ...
            if ((menuItem.key !== EMenuItemKey.Editor && !(menuItem === null || menuItem === void 0 ? void 0 : menuItem.isActive)) ||
                ...
                if (showCustomEditor && !isOpen && !compactView) {
                    ...
                    return (<SubMenu key={menuItem.key} title={menuTitles(menuItem.key)} icon={(menuItem === null || menuItem === void 0 ? void 0 : menuItem.icon) && <i className={menuItem.icon}/>} onTitleClick={() => {
                ...
                {layoutEditorItem && (<FeaturesNavItem key={layoutEditorItem.key} isSubMenuItem={true} menuItem={layoutEditorItem} handleNavigation={handleNavigation}/>)}
                {studioModeItem && (<FeaturesNavItem key={studioModeItem.key} isSubMenuItem={true} menuItem={studioModeItem} handleNavigation={handleNavigation} className={studioMode && styles.active}/>)}
              </SubMenu>);
                }
            }
                ...
                return (<SubMenu key={menuItem.key} title={menuTitles(menuItem.key)} icon={(menuItem === null || menuItem === void 0 ? void 0 : menuItem.icon) && <i className={menuItem.icon}/>} onTitleClick={() => {
                        ...
                        expandMenuItem(ENavName.TopNav, menuItem.key);
                    }} className={cx(!isOpen && styles.closed, currentMenuItem === menuItem.key && styles.active)}>
              {(_a = menuItem === null || menuItem === void 0 ? void 0 : menuItem.subMenuItems) === null || _a === void 0 ? void 0 : _a.map((subMenuItem) => (<FeaturesNavItem key={subMenuItem.key} isSubMenuItem={true} menuItem={subMenuItem} handleNavigation={handleNavigation}/>))}
              ...
              {menuItem.key === EMenuItemKey.AppStore && <AppsNav type="enabled"/>}
                ...
                return (!isHidden && (<FeaturesNavItem key={menuItem.key} menuItem={menuItem} handleNavigation={handleNavigation}/>));
            }
        })}

      {loggedIn && !compactView && (<AppsNav />)}
    </Menu>);
}
function FeaturesNavItem(p) {
    ...
    function setIcon() {
        if (menuItem.key === EMenuItemKey.Highlighter) {
            ...
            return <i className={menuItem === null || menuItem === void 0 ? void 0 : menuItem.icon}/>;
        }
    }
    const title = useMemo(() => {
    ...
    return (<MenuItem className={cx(className, !isSubMenuItem && !isOpen && styles.closed, !isSubMenuItem &&
            menuItem.key === EMenuItemKey.StudioMode &&
            studioMode &&
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        {title}
        {menuItem.key === EMenuItemKey.Highlighter && aiHighlighterFeatureEnabled && (<div className={styles.betaTag}>
            <p style={{ margin: 0 }}>
...
const HighlighterIcon = () => (<svg width="12px" height="12px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" className="highlighter" style={{ fill: 'var(--paragraph)' }}>
    <g clipPath="url(#clip0)">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M5.30361 2.56988L8.88907 1.71484L11.4745 5.15035L7.64504 6.01543L7.64807 6.01989L4.51906 6.75186L2.27539 3.28364L5.30125 2.56641L5.30361 2.56988Z"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M17.3426 0.851841L17.9811 3.27371C18.0066 3.37275 17.9916 3.47709 17.9391 3.5641C17.8865 3.65111 17.801 3.71339 17.7012 3.7359L14.3855 4.42042L12.2759 4.96974L9.68604 1.52675L10.6496 1.34058L15.9974 0.028045C16.5924 -0.107742 17.1956 0.262868 17.3426 0.851841Z"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M8.26681 6.75197L8.26877 6.74707H11.2121L10.0116 9.74741H7.06836L7.06862 9.74676H3.31689L4.51918 6.75212L8.26681 6.75197Z"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M10.8198 9.74741L12.0203 6.74707H15.7717H16.5H17.6181C17.8259 6.74707 17.9932 6.91437 17.9933 7.12218V9.74815H14.5713L14.5716 9.74741H10.8198Z"/>
...
//# sourceMappingURL=FeaturesNav.jsx.map