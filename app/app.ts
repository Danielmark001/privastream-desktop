...
export const apiInitErrorResultToMessage = (resultCode: obs.EVideoCodes) => {
  switch (resultCode) {
    case obs.EVideoCodes.NotSupported: {
      return 'Failed to initialize PrivaStream Desktop. Your video drivers may be out of date, or PrivaStream Desktop may not be supported on your system.';
    }
    ...
    default: {
      return 'An unknown error was encountered while initializing PrivaStream Desktop.';
    }
  }
};
