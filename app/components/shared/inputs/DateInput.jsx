...
let DateInput = class DateInput extends BaseInput {
    ...
    render() {
        return (<span data-role="input" data-type="date" data-name={this.options.name} class={styles['date-input']}>
        <Datepicker language={this.locale} value={this.date} disabledDates={this.disabledDates} onInput={(value, ev) => this.emitInput(value ? +value : null, ev)}/>
        <input type="hidden" value={this.value} name={this.options.uuid} v-validate={this.validate}/>
      </span>);
    }
};
__decorate([
