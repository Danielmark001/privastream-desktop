...
let BoolInput = class BoolInput extends BaseInput {
    ...
    render() {
        return (<div class={cx('input-wrapper', { disabled: this.options.disabled })} data-role="input" data-type="bool" data-name={this.options.name}>
...
//# sourceMappingURL=BoolInput.jsx.map