...
let BoolInput = class BoolInput extends BaseInput {
    ...
    render() {
        ...
        return (React.createElement("div", { class: cx('input-wrapper', { disabled: this.options.disabled }), "data-role": "input", "data-type": "toggle", "data-value": !!this.value, "data-name": this.options.name },
            React.createElement("div", { class: cx(styles.boolButton, { [styles.active]: !!this.value }), style: customStyles, onClick: () => this.handleClick() }, (_a = this.options.title) !== null && _a !== void 0 ? _a : (this.value && React.createElement("i", { class: "fa fa-check" }))),
