...
let TextInput = class TextInput extends BaseInput {
    ...
    get toggleVisibleButton() {
        return (this.metadata.masked && (React.createElement("button", { class: cx('button', styles.buttonInput, 'button--default'), onClick: this.toggleVisible }, this.textVisible ? $t('Hide') : $t('Show'))));
    }
    handleInput(value) {
    ...
    render() {
        return (React.createElement("span", { class: cx(styles.textInput, {
