...
let ImageUploaderInput = class ImageUploaderInput extends BaseInput {
    ...
    render() {
        return (<div data-role="input" data-type="imageUploader" data-name={this.options.name} class={styles.imageUploader}>
        {this.imageUrl && <img src={this.imageUrl} alt="" class={styles.image}/>}
        {!this.hasNonDefaultValue && (<div class={styles.footer}>
        ...
        <label class={styles.fileLabel}>
          <input type="file" onchange={(ev) => this.onFileChangeHandler(ev)} accept=".jpg, .png, .jpeg"/>
        </label>
        {this.hasNonDefaultValue && (<div class={styles.footer}>
...
//# sourceMappingURL=ImageUloaderInput.jsx.map