...
let TagsInput = class TagsInput extends BaseInput {
    ...
    renderTag(val) {
        ...
        return (React.createElement("span", { class: styles.tag, style: style },
            tag.title,
            React.createElement("i", { class: "fa fa-times", onClick: m.stop((e) => this.removeTag(e, val)) })));
    }
};
__decorate([
    Prop()
