...
let MediaShare = class MediaShare extends WidgetSettings {
    ...
    get banList() {
        ...
        return (this.wData &&
            this.wData.banned_media.map(media => (<div vTooltip={$t('Banned by %{user}', { user: media.action_by })} class={styles.banlistCell}>
    ...
    get form() {
        return (this.loaded && (<ValidatedForm slot="media-properties" onInput={() => this.save()}>
    ...
    render() {
        return (this.wData && (<WidgetEditor slots={[{ value: 'banlist', label: $t('Banned Media') }]} navItems={this.navItems}>
...
//# sourceMappingURL=MediaShare.jsx.map