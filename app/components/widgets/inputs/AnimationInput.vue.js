...
let AnimationInput = class AnimationInput extends BaseInput {
    get listInputMetadata() {
        switch (this.options.filter) {
            case 'in':
                return Object.assign(Object.assign({}, this.options), { options: inAnimations() });
            case 'out':
                return Object.assign(Object.assign({}, this.options), { options: outAnimations() });
            case 'text':
                return Object.assign(Object.assign({}, this.options), { options: textAnimations() });
            case 'eventIn':
                return Object.assign(Object.assign({}, this.options), { options: eventInAnimations() });
            case 'eventOut':
                return Object.assign(Object.assign({}, this.options), { options: eventOutAnimations() });
            default:
                return Object.assign(Object.assign({}, this.options), { options: textAnimations().concat(inAnimations()).concat(outAnimations()) });
        }
    }
};
__decorate([
    Prop()
], AnimationInput.prototype, "value", void 0);
__decorate([
    Prop()
], AnimationInput.prototype, "metadata", void 0);
__decorate([
    Prop()
], AnimationInput.prototype, "title", void 0);
AnimationInput = __decorate([
    Component({
        components: { ListInput },
    })
], AnimationInput);
export default AnimationInput;
//# sourceMappingURL=AnimationInput.vue.js.map