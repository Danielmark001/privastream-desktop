...
let GoogleFontSelector = class GoogleFontSelector extends ObsInput {
    ...
    render() {
        return (React.createElement("div", { class: "google-font-selector" },
            React.createElement("div", null,
                React.createElement(HFormGroup, { value: this.selectedFamily, onInput: (family) => this.setFamily(family), metadata: this.metadata.fontFamily }),
                React.createElement(HFormGroup, { value: this.selectedStyle, onInput: (style) => this.setStyle(style), metadata: this.metadata.fontStyle }),
                React.createElement(ObsFontSizeSelector, { value: this.value.size, onInput: (size) => this.setSize(size) }))));
    }
};
__decorate([
    Inject()
...
//# sourceMappingURL=ObsGoogleFontSelector.js.map