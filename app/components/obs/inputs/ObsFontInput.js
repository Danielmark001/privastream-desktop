...
let ObsFontInput = class ObsFontInput extends ObsInput {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement(HFormGroup, { value: this.isGoogleFont, onInput: (val) => this.setFontType(val), metadata: metadata.bool({ title: $t('Use Google Font') }) }),
            this.isGoogleFont && (React.createElement(GoogleFontSelector, { value: this.googleFont, onInput: font => this.setGoogleFont(font) })),
            !this.isGoogleFont && (React.createElement(ObsSystemFontSelector, { value: this.value, onInput: font => this.setFont(font) }))));
    }
};
__decorate([
    Prop()
...
//# sourceMappingURL=ObsFontInput.js.map