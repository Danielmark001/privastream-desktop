...
let BrowserSourceInteraction = class BrowserSourceInteraction extends TsxComponent {
    ...
    render() {
        return (<ModalLayout showControls={false} contentStyles={{ padding: '0px' }}>
        <div slot="content" onWheel={this.onWheel} onMousedown={this.onMousedown} onMouseup={this.onMouseup} onMousemove={this.onMousemove} onKeydown={this.onKeydown} onKeyup={this.onKeyup} tabindex="0" style={{ outline: 'none', height: '100%' }} ref="eventDiv">
          <Display componentProps={{
...
//# sourceMappingURL=BrowserSourceInteraction.jsx.map