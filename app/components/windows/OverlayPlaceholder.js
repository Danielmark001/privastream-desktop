...
let OverlayPlaceholder = class OverlayPlaceholder extends TsxComponent {
    render() {
        return (React.createElement("div", { class: styles.container },
            React.createElement("div", { class: styles.outline },
                React.createElement("h1", { class: styles.title }, this.title))));
    }
};
__decorate([
    Prop()
...
//# sourceMappingURL=OverlayPlaceholder.js.map