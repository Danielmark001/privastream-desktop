...
let SceneTransitions = class SceneTransitions extends TsxComponent {
    ...
    render() {
        return (<div>
        <VFormGroup value={this.fromSceneModel} onInput={this.setFromSceneModel} metadata={metadata.list({
                title: $t('Beginning Scene'),
                name: 'from',
                options: this.sceneOptions,
            })}/>
        <VFormGroup value={this.transitionModel} onInput={this.setTransitionModel} metadata={metadata.list({
                title: $t('Scene Transition'),
                name: 'transition',
                options: this.transitionOptions,
            })}/>
        <VFormGroup value={this.toSceneModel} onInput={this.setToSceneModel} metadata={metadata.list({
...
//# sourceMappingURL=ConnectionSettings.jsx.map